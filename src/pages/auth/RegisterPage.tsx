    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-sm mt-1">Join the Animeastral universe</p>
        </div>
        ...
        <div className="rounded-lg p-6" style={{ backgroundColor: "#111", border: "1px solid #222" }}>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input type="text" value={username} onChange={(e) => setUsername(e.target.value)} placeholder="yourname" required minLength={3} className="input" />
            </div>
            <div>
            ...
            <div>
              ...
              <div className="relative">
                <input type={showPass ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" required minLength={6} className="input pr-10" />
          ...
          <p className="mt-5 text-center text-sm text-gray-600">
            ...
            <Link to="/login" className="font-medium hover:text-white transition-colors" style={{ color: "#f5a623" }}>Sign in</Link>
          </p>
        </div>
      </div>
    </div>
